...
// `~/.config/hypr/gigishell/keybinds.lua` (+ `gigishell/variables.lua`) y delega el
...
const KEYBINDS_LUA = `${HYPR}/gigishell/keybinds.lua`
const VARIABLES_LUA = `${HYPR}/gigishell/variables.lua`
