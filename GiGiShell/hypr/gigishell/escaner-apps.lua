-- gigishell/escaner-apps.lua — al empezar la sesión, te lleva al escritorio donde
...
--   - 2 o más                 → GiGiShell.compactar() primero (que no queden
...
-- daemon). GIGISHELL_ESCANER_SEGS acorta la ventana para probarlo sin esperar
...
hl.on("hyprland.start", function()
  ...
  local segs = tonumber(os.getenv("GIGISHELL_ESCANER_SEGS") or "") or 30
