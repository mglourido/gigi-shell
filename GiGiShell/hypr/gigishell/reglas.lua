-- gigishell/reglas.lua — reglas de ventana y de capa.
--
...
-- ventana abierta `hyprctl clients` devuelve `class: gigishell-camara-preview`, así
...
hl.window_rule({
    ...
    match = { class = "gigishell-camara-preview" },
    float  = true,
    center = true,
    size   = "640 480",
})
