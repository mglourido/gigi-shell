-- gigishell/tapa.lua — qué hace el portátil al CERRAR LA TAPA (Ajustes > Energía).
--
-- Atado en gigishell/keybinds.lua a `switch:on:Lid Switch` / `switch:off:Lid Switch`
...
-- sin relanzar ni recargar nada. Mismo contrato que gigishell/boton-apagado.lua, del
...
--- volvería a encender (mouse_move_enables_dpms = false en gigishell/ventanas.lua), y
