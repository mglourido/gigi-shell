-- gigishell/orion.lua — GiGiShell.toggle_orion(), el atajo del launcher Orion
-- (SUPER + ALT + SPACE, bind en gigishell/keybinds.lua).
--
...
-- efecto hasta el siguiente reload). Mismo criterio que gigishell/boton-apagado.lua.
--
...
local RUTA_PREFS = util.HOGAR .. "/.config/gigishell/preferences.json"
...
function GiGiShell.toggle_orion()
