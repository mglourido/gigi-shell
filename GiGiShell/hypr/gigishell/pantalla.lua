-- Preferencias por monitor: se LEEN de ~/.config/gigishell/display.json, la misma
...
--
-- Se carga DESPUÉS del comodín de gigishell/monitores.lua: una spec con `desc:`
...
local prefs = util.leer_json(util.HOGAR .. "/.config/gigishell/display.json")
