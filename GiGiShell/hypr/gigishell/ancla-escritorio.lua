-- gigishell/ancla-escritorio.lua — un escritorio "ancla" al que ir y del que volver.
--
...
local RUTA = (os.getenv("XDG_RUNTIME_DIR") or "/tmp") .. "/gigishell-ancla-escritorio"
...
-- usuario — el mismo criterio que gigishell/limite-ventanas.lua y compactar.lua.
