-- gigishell/autostart.lua — lo que se lanza al iniciar la sesión, escalonado.
--
...
-- 30 s de gigishell/escaner-apps.lua) sí acepta ese riesgo: perderla solo cuesta
...
hl.on("hyprland.start", function()
  ...
  -- ~/.config/gigishell/apps-inicio.json; aquí solo vive el momento en que se
  ...
  --
  -- Cae DENTRO de la ventana de 30 s de gigishell/escaner-apps.lua a propósito:
  ...
  -- ~/.config/gigishell/spotify-creds.json — no se arranca ningún ksecretd/KWallet.
end)
