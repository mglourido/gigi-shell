-- gigishell/limite-ventanas.lua — tope de ventanas EN MOSAICO por escritorio.
--
...
--
-- Ajuste: `maxVentanasEscritorio` en ~/.config/gigishell/preferences.json.
...
-- el destino. Ver gigishell/ventanas.lua. pcall + repliegue por la trampa nº 1.
