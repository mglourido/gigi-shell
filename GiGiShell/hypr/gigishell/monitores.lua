...
-- preferencia guardada (las concretas salen de display.json, ver gigishell/pantalla.lua).
--
-- Configuración genérica: usa la resolución preferida del monitor a escala 1.
-- Es solo el fallback: gigishell/pantalla.lua se carga DESPUÉS y sus specs por
