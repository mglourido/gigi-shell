...
# NO se symlinkea desde ~/GiGiShell: corre como root vía la regla /etc/sudoers.d/gigios-tlp, y
...
# /etc/gigios/tlp/, también root-owned; la copia versionada en ~/GiGiShell/system/tlp/ solo se
